...
int main(){
	...
	*/
	...
	cout << "Valor Double digitado: " << endl;
	...
	cout << "Index do começo de Lima: " << meunome.find("lima", 0) << endl, endl;
	...
	//Podemos também substituir, informando foda-se, vou dormir
	meunome.replace(6, 5, "maximus");
	cout << meunome << endl, endl;
